...
obj_player.ac = ini_read_real("Player Values", "ac", 10);
...
while(ini_key_exists("Enemy Values", string(a) + " name"))
{
    ...
    switch (name)
    {
        case "orc":
            ...
            test.level = ini_read_real("Enemy Values", string(a) + " level", 1);
            break;
        case "kobold":
            ...
            test.gold = ini_read_real("Enemy Values", string(a) + " gold", 0);
            test.hp = ini_read_real("Enemy Values", string(a) + " hp", 1);
            test.level = ini_read_real("Enemy Values", string(a) + " level", 0);
            break;
    }
    a++;
}
