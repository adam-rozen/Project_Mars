...
if (argument0.itemType == "armor")
{
    ...
    ini_write_string(base64_encode("Player Inventory"), base64_encode(string(i) + " price"), base64_encode(string(argument0.price)));
...
else if (argument0.itemType == "weapon")
{
    ...
    ini_write_string(base64_encode("Player Inventory"), base64_encode(string(i) + " toHitBonus"), base64_encode(string(argument0.toHitBonus)));
    ini_write_string(base64_encode("Player Inventory"), base64_encode(string(i) + " hands"), base64_encode(string(argument0.hands)));
    ini_write_string(base64_encode("Player Inventory"), base64_encode(string(i) + " weight"), base64_encode(string(argument0.weight)));
    ini_write_string(base64_encode("Player Inventory"), base64_encode(string(i) + " damageSmall[0]"), base64_encode(string(argument0.damageSmall[0])));
    ini_write_string(base64_encode("Player Inventory"), base64_encode(string(i) + " damageLarge[0]"), base64_encode(string(argument0.damageLarge[0])));
    ini_write_string(base64_encode("Player Inventory"), base64_encode(string(i) + " itemType"), base64_encode(argument0.itemType));
    ini_write_string(base64_encode("Player Inventory"), base64_encode(string(i) + " weaponType"), base64_encode(argument0.weaponType));
}
